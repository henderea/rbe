...
root_command[:alias][:static] = command(short_desc: 'static SUBCOMMAND ARGS...', desc: 'configure static bash alias functions')

root_command[:alias][:static][:add] = command(short_desc: 'add alias_name', desc: 'create a static alias') { |alias_name|
}
